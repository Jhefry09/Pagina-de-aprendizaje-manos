...
const Navbar = ({ activeLink = "inicio" }: NavbarProps) => {
  ...
  // Inicializar hook de voz con configuración en español
  ...
  const handleModuleNavigation = (route: string) => {
    // Mensaje de navegación según el módulo
    switch (route) {
      case "/vocales":
        speak(VoiceMessages.NAVIGATION_VOCALES);
        break;
      case "/abecedario":
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <a href="/" className="flex items-center space-x-2 group">
              <span className="text-2xl font-bold text-white">SeeTalk</span>
          ...
          <div className="hidden md:flex items-center space-x-2 ml-8">
            <NavLink href="/home" isActive={activeLink === "inicio"}>
              Inicio
            </NavLink>
            ...
            {isAdmin && (
              <>
                <NavLink href="/training">Entrenar IA</NavLink>

                <NavLink
                  href="/estadisticas"
                  isActive={activeLink === "estadisticas"}
                >
                  Estadísticas
                </NavLink>
          ...
          <div className="hidden md:flex items-center">
            <div className="relative">
              ...
              {isProfileDropdownOpen && (
                <div
                  className={`absolute right-0 mt-2 w-56 rounded-xl shadow-xl bg-gray-800/95 backdrop-blur-sm border border-gray-700/50 z-[99999] overflow-hidden transition-all duration-200 origin-top-right ${
                    isProfileDropdownOpen
                      ? "opacity-100 scale-100 translate-y-0 pointer-events-auto"
                      : "opacity-0 scale-95 -translate-y-1 pointer-events-none"
                  }`}
      ...
      >
        <div className="mx-4 mt-2 bg-slate-900/95 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl">
          <div className="px-4 pt-2 pb-3 space-y-1">
            ...
            <div className="px-2">
              <p className="text-xs uppercase font-semibold text-gray-400 px-2 py-1">
                Clases
              </p>
              {modules.map((module) => (
                <button
